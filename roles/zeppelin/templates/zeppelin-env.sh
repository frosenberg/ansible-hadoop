...
##
export SPARK_HOME={{ spark.location }}                             # (required) When it is defined, load it instead of Zeppelin embedded Spark libraries
...
export HADOOP_CONF_DIR=/usr/lib/hadoop       		# yarn-site.xml is located in configuration directory in HADOOP_CONF_DIR.
